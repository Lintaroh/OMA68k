...
CONIN	EQU	$813FA				; Monitor CONIN  (from unimon_68000.lst)
CONOUT	EQU	$8141A				; Monitor CONOUT (from unimon_68000.lst)
CONST	EQU	$8140E				; Monitor CONST  (from unimon_68000.lst)

	ORG	$00084000			; ROM base for EhBASIC
...
; Use this value to run out of RAM
	ORG		$00084006			; past the jmp instruction
